...
/**
 * Unit test for {@link DocbookImporter} for DocBook 4.3 support.
 * 
 * @author Vlastimil Elias (velias at redhat dot com)
 */
public class DocbookImporter_DocBook_4_3_Test extends DocbookImporterTestBase {

  private static final Logger log = Logger.getLogger(DocbookImporter_DocBook_4_3_Test.class);
  ...
  public void validateImageFilesExists() throws Exception {
    File srcdir = prepareTestSourceDirectory("docbook-4.3-ok.zip");
    File srcdir2 = prepareTestSourceDirectory("docbook-4.3-badimagereferences.zip");
    try {
  ...
  public void prepareChapterWIKIContent_chapterIndexingAndNoTitleTest() throws Exception {
    ...
    URL url = getTestResourceFileURL("chapterwiki_docbook_4_3/chapterIndexingAndNoTitleTest.xml");
  ...
  public void prepareChapterWIKIContent_basicTextFormatingTest() throws Exception {
    ...
    URL url = getTestResourceFileURL("chapterwiki_docbook_4_3/basicTextFormatingTest.xml");
    ...
    log.debug(ret);
    // we also test <para> here so double EOL after all sentences!
    Assert.assertTrue(ret.contains("test with *bold* and *bold2* text\n\n"));
  ...
  public void prepareChapterWIKIContent_sectionsToHeaderTest() throws Exception {
    ...
    URL url = getTestResourceFileURL("chapterwiki_docbook_4_3/sectionsToHeaderTest.xml");
    tested.normalizeDocBookXMLFileContent(new File(url.toURI()));
  ...
  public void prepareChapterWIKIContent_programListingTest() throws Exception {
    ...
    URL url = getTestResourceFileURL("chapterwiki_docbook_4_3/programListingTest.xml");
    tested.normalizeDocBookXMLFileContent(new File(url.toURI()));
  ...
  public void prepareChapterWIKIContent_admonitionsTest() throws Exception {
    ...
    URL url = getTestResourceFileURL("chapterwiki_docbook_4_3/admonitionsTest.xml");
    tested.normalizeDocBookXMLFileContent(new File(url.toURI()));
  ...
  public void prepareChapterWIKIContent_listsTest() throws Exception {
    ...
    URL url = getTestResourceFileURL("chapterwiki_docbook_4_3/listsTest.xml");
    tested.normalizeDocBookXMLFileContent(new File(url.toURI()));
  ...
  public void prepareChapterWIKIContent_listsTestBasic() throws Exception {
    ...
    URL url = getTestResourceFileURL("chapterwiki_docbook_4_3/listsTestBasic.xml");
    tested.normalizeDocBookXMLFileContent(new File(url.toURI()));
  ...
  public void prepareChapterWIKIContent_tableTestBasic() throws Exception {
    ...
    URL url = getTestResourceFileURL("chapterwiki_docbook_4_3/tableTestBasic.xml");
    tested.normalizeDocBookXMLFileContent(new File(url.toURI()));
  ...
  public void prepareChapterWIKIContent_linkExternalTest() throws Exception {
    ...
    URL url = getTestResourceFileURL("chapterwiki_docbook_4_3/linkExternalTest.xml");
    tested.normalizeDocBookXMLFileContent(new File(url.toURI()));
  ...
  public void prepareChapterWIKIContent_linkInternalTest() throws Exception {
    ...
    URL url = getTestResourceFileURL("chapterwiki_docbook_4_3/linkInternalTest.xml");
    tested.normalizeDocBookXMLFileContent(new File(url.toURI()));

    DocStructureItem chapterInfo = prepareTestChapter1Info();
    String ret = tested.prepareNodeWIKIContent(url.openStream(), url.toString(), chapterInfo, TESTED_DOCBOOK_VERSION);
    log.debug(ret);
    Assert.assertEquals("some 1 link [id-LinkPage] go\n\nsome 2 link [id-LinkPage2] go\n\n", ret);
  }
  ...
  public void prepareChapterWIKIContent_imageTest() throws Exception {
    ...
    URL url = getTestResourceFileURL("chapterwiki_docbook_4_3/imageTest.xml");
    tested.normalizeDocBookXMLFileContent(new File(url.toURI()));
  ...
  public void prepareChapterWIKIContent_variablelistTest() throws Exception {
    ...
    URL url = getTestResourceFileURL("chapterwiki_docbook_4_3/variablelistTest.xml");
    tested.normalizeDocBookXMLFileContent(new File(url.toURI()));
  ...
  public void prepareChapterWIKIContent_procedureTest() throws Exception {
    ...
    URL url = getTestResourceFileURL("chapterwiki_docbook_4_3/procedureTest.xml");
    tested.normalizeDocBookXMLFileContent(new File(url.toURI()));
  ...
  public void completeParsingTest() throws Exception {
    ...
    if (internal) {
      srcdir = prepareTestSourceDirectory("docbook-4.3-ok.zip");
